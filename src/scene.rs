...
impl Scene {
    pub fn new(spheres: Vec<Sphere>, planes: Vec<Plane>, rectangles: Vec<Rectangle>) -> Scene {
        Scene {
            spheres: spheres,
            planes: planes,
    ...
    pub fn intersect(&self, ray: Ray) -> Option<(Intersection, f64)> {
        ...
        for s in 0..self.planes.len() {
            ...
            if hit_t < prev_t && hit_t > 1e-6 {
                ...
                intersection_position = plane.position;
        ...
        for s in 0..self.rectangles.len() {
            ...
            if hit_t < prev_t && hit_t > 1e-6 {
                ...
                intersection_position = rectangle.position;
